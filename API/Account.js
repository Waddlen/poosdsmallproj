                ...
                if (this.readyState == 4 && this.status == 200)
                {
                        ...
                        for (var i = 0; i < jsonObject.results.length; i++)
                    {
                        ...
                        if (error == "")
                        {
                            ...
                            newContactinfo.insertCell(1).outerHTML = '<td scope="col">'+jsonObjectTwo.ContactFirstName+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                            newContactinfo.insertCell(2).outerHTML = '<td scope="col">'+jsonObjectTwo.ContactLastName+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                            newContactinfo.insertCell(3).outerHTML = '<td scope="col">'+jsonObjectTwo.ContactNumber+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                            newContactinfo.insertCell(4).outerHTML = '<td scope="col">'+jsonObjectTwo.Address+"</th>";
                            var Contactid = jsonObjectTwo.Contactid;
                            newContactinfo.insertCell(5).outerHTML = '<td scope="col"><button type="button" value="'+jsonObjectTwo.Contactid+'" onclick="setUpdateId(this.value)" class="btn btn-primary btn" data-toggle="modal" data-target="#EditContactModal">Edit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
                            newContactinfo.insertCell(6).outerHTML = '<td scope="col"><button type="button" value="'+jsonObjectTwo.Contactid+'" class="btn btn-primary btn" onclick="deleteThis(this, this.value)">Delete</button></td>';
