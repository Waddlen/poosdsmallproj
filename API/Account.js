            ...
            xhr.onreadystatechange = function()
            {
                if (this.readyState == 4 && this.status == 200)
                {
                    ...
                    for (var i = 0; i < jsonObject.results.length; i++)
                    {
                        ...
                        newContactinfo.insertCell(5).outerHTML = '<td><button type="button" value=jsonObject.Contactid class="btn btn-primary btn" data-toggle="modal" data-target="#EditContactModal">Edit</button></td>';
                        newContactinfo.insertCell(6).outerHTML = '<td><button type="button" value=jsonObject.Contactid class="btn btn-primary btn" onclick="deleteThis(this)">Delete</button></td>';
